...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_cost_estimate = (words_count / 0.75) / 1000 * PRICING_PER_1K_TOKENS["gpt-4o"]["output"]
...
def run_assistant(
    ...
    while True:
        ...
        num_turns += 1
        turn_cost_info = estimate_cost(user_msg, reply)
        total_tokens += turn_cost_info["input_tokens"] + turn_cost_info["output_tokens"]
        total_cost += turn_cost_info["total_cost"]
